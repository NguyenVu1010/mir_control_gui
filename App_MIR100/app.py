...
from pages.missions.layout import mission_queue_layout 
from pages.missions.callbacks import register_callbacks
...
def update_battery_status(n):
    try:
        response = requests.get("http://robot-ip/api/battery")  # Thay thế bằng API thật của bạn
        data = response.json()
...
# Thêm Interval để cập nhật mỗi 5 giây
...
def update_active_link(pathname):
    nav_links = [
        ...
        {"href": "/missions", "id": "missions-link", "label": "Missions"},
