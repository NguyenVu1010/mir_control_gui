...
class RVizSection:
    ...
    def create_composite_image(self):
        try:
            map_img = Image.open("static/map_image.png")
            if map_img.mode != 'RGBA':
                map_img = map_img.convert('RGBA')

            lidar_f_img = Image.open("static/f_scan_image.png").convert("RGBA")
            lidar_b_img = Image.open("static/b_scan_image.png").convert("RGBA")
            robot_img = Image.open("static/robot_image.png").convert("RGBA")
            path_img = Image.open("static/path_image.png").convert("RGBA")
